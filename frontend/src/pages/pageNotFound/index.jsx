...
export const PageNotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 relative overflow-hidden flex items-center justify-center">
      ...
      <div
        className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-blue-200/20 to-purple-200/20 rounded-full animate-pulse pointer-events-none"
        style={{ animationDelay: '1s' }}
      ></div>
      <div
        className="absolute top-1/2 left-10 w-48 h-48 bg-gradient-to-r from-pink-200/25 to-purple-200/25 rounded-full animate-pulse pointer-events-none"
        style={{ animationDelay: '2s' }}
      ></div>

      {/* Main Content */}
      <div
        className={`relative z-10 text-center max-w-4xl mx-auto px-6 transform transition-all duration-1000 ${
      ...
      >
        ...
        >
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">
            ...
            perhaps the URL was mistyped. Let's get you back on track to
            discover amazing entrepreneurs and innovators!
          </p>
        </div>

        {/* Action Buttons */}
        <div
          className={`flex flex-col sm:flex-row gap-4 justify-center mb-16 transform transition-all duration-1000 delay-700 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
          }`}
        >
          <button
