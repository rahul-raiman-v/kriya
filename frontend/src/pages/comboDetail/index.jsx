...
export function ComboDetail() {
  const selectedCombo = useComboPageStore(
  ...
  return (
    <div className="h-[calc(100dvh-11.3rem)] overflow-y-auto no-scrollbar bg-gray-50 p-4 sm:p-10 flex flex-col items-center font-sans">
          ...
          <div className="flex-1 rounded-2xl overflow-hidden">
            <img
              ...
              onError={(e) => {
                ...
                e.target.src =
                  'https://placehold.co/600x300/E0F2F7/000000?text=Image+Error';
              }}
            />
          </div>
