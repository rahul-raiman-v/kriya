...
export const useComboStore = create(() => ({
  ComboData: [
    ...
    // },
    {
      id: 1,
      combo: 'Classic Combo',
      events: '1 Technical Event + 1 Non Technical Event',
      hostel: 'Lunch and Refreshments are Included',
      accommodation: '(Accomodation not available)',
      prize: 'Exciting Prizes!',
      // ticket: 'Tickets for Star Night (Culturals) are included!',
      fee: '450.00',
      link: 'https://forms.gle/27ts8Y3EMrCZ2m9g9',
